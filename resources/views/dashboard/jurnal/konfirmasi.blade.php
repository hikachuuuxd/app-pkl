...
<div class="h-full ml-14 mt-14 mb-10 md:ml-64">
    <div class="container">
        <h3 class="uppercase text-2xl m-6">Konfirmasi Jurnal Siswa</h3>
        <hr class=" w-screen">
    </div>
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                          ...
                          @foreach ( $jurnals as $jurnal )
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-center   p-3">
                                @if($jurnal->konfirmasi == 0)
                                    <form action="{{ route('konfirmasi.update', $jurnal->id )}}" method="post">
                                        @csrf
                                        @method('PUT')
                                    <button type="submit" class="bg-red-400 text-white hover:bg-purple-200 hover:text-purple-600 py-1 px-3  rounded-full text-xs">konfirmasi</button>
                                    </form>
                                @else
