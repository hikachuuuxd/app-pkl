    ...
    <div class="overflow-x-auto">
        ...
        <div class="max-w-screen max-h-screen flex items-center justify-center  font-sans overflow-hidden">
            <div class="w-full lg:w-[90%]">
                ...
                <button disabled="disabled"  class="hidden p-4 mt-5 bg-blue-900 text-white rounded hover:bg-blue-700 hover:text-white"><a href="{{ route('jurnal.create') }}">Tambah Jurnal</a></button>
               @else
               <button class="p-4 mt-5 bg-blue-900 text-white rounded hover:bg-blue-700 hover:text-white"><a href="{{ route('jurnal.create') }}">Tambah Jurnal</a></button>
               @endif
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-center">
                                    ...
                                    @foreach ($jurnal->images as $image)
                                        <div class="w-10 h-10 inline-block "><img src="{{ $image->image }}" alt=""></div>
                                    @endforeach
